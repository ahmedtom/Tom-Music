...
Copyright (c) 2022-present levina=lab <https://github.com/ahmedtom>
...
async def start_set(_, query: CallbackQuery):
  ...
  (http://t.me/Tom_01157)اެناެ بَۅت بَمميࢪ࣪اެتَ متَعدَدةَ ݪتشغِيݪ اެݪاغاެنِي فَي اެݪمَجمَۅعاتَ 🥇اعمل على سورس المطور توم ويوزرو .
...
تقدر تشوف كل اوامر البوت عن طريق زر اوامر البوت""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
...
-› شغل او تشغيل او توم او /تشغيل او /play - بالرد على ملف صوتي او اسم أغنيه
-› اصعد - لصعود حساب المساعد في المكالمة
-› انزل - لنزول المساعد من المكالمة
-› تخطي - لتخطي اغنية في التشغيل
-› كافي او ايقاف او /ايقاف او /end - لايقاف تشغيل جميع الاغاني
...
. شكراً لقرائتك الاوامر - أتمنى لك يوماً تعيساً تحت رعاية توم 🦴 """,
        reply_markup=InlineKeyboardMarkup(
...
async def at_set_markup_menu(_, query: CallbackQuery):
    ...
    if not a.can_manage_voice_chats:
        return await query.answer("💡 متتكاش  هنا يا حبيبي الي معاه صلاحية الكول بس            !", show_alert=True)
    ...
    if chat_id in QUEUE:
        ...
        await query.answer("مفيش حاجه شغاله يا حب🌵.", show_alert=True)
